  ...
  - dimension: postal_area1
    ...
    sql: |
       CASE 
            ...
            WHEN TRANSLATE(substring(${postal_code},1,2), '1234567890', '') = 'B' THEN 'B'
            ...
            WHEN TRANSLATE(substring(${postal_code},1,2), '1234567890', '') = 'E' THEN 'E'
            ...
            WHEN TRANSLATE(substring(${postal_code},1,2), '1234567890', '') = 'G' THEN 'G'
            ...
            WHEN TRANSLATE(substring(${postal_code},1,2), '1234567890', '') = 'L' THEN 'L'
            ...
            WHEN TRANSLATE(substring(${postal_code},1,2), '1234567890', '') = 'M' THEN 'M'
            ...
            WHEN TRANSLATE(substring(${postal_code},1,2), '1234567890', '') = 'N' THEN 'N'
            ...
            WHEN TRANSLATE(substring(${postal_code},1,2), '1234567890', '') = 'S' THEN 'S'
            ...
            WHEN TRANSLATE(substring(${postal_code},1,2), '1234567890', '') = 'W' THEN 'W'
