view: ga_sessions_greatmagazines {
  sql_table_name: ( SELECT * FROM {% table_date_range date_filter 18457891.ga_sessions_ %},
      {% table_date_range date_filter 18457891.ga_sessions_intraday_ %})
     ;;
     # - view: ga_sessions
     #   sql_table_name: |
