...
#     }
  ...
  dimension: Brand_Network {
    hidden: no
    label: "Brand Network"
    suggestions: ["Absolute Network","BCN","BCN 2","BCN 3","BCN Ext","Heat Network","Kerrang Network","Kiss Network","Magic Network","Planet Rock Network"]
    type: string
    sql: CASE
  ...
  dimension: Brand_Network2 {
    hidden: no
    label: "Brand Network Rollup"
    type: string
    sql: CASE
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/kiss/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/hits/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/kerrang/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/magic/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absolute-80s/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absolute-classic-rock/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absolute-radio-00s/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absolute-radio-60s/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absolute-radio-70s/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absolute-radio-90s/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absolute-radio/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absolute/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/absoluteradio/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/aire-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/aire2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/aire-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/aire3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/aire/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/borders/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/cfm/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/city-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/city-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/city2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/city3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/city-talk/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/city/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/clyde-1/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/clyde1/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/citytalk/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/clyde-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/clyde2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/clyde-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/clyde3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/clyde/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/cool-fm/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/coolfm/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/downtown/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/downtown-country/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/forth-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/forth2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/forth-1/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/forth1/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/forth-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/forth/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/forth3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/free-radio/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/free/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/free-80/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/free-80s/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/free-coventry/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/free-cov/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/freeradio/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/gem-106/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/gem106/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/gem/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/hallam-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/hallam2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/hallam-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/hallam3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/hallam-fm/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/hallam/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/hallamfm/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/heat/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/key-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/key2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/key-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/key3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/key-103/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/key/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/key103/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/kiss-fresh/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/kisstory/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/magic-chilled/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/mellow-magic/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/magic-mellow/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/magic-soul/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/metro-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/metro/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/metro-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/mfr-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/mfr-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/mfr/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/northsound-1/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/northsound-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/northsound/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/planet-rock/%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/tfm/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/tfm-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/rock-fm/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/rockfm/' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/west/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/wave-105/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/wave/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/wave105/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/viking/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/viking-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/viking-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/tay/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/tay-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/westsound/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/westsound-fm/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/tfm-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/rock/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/tay-3/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/radioborders/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/free80s/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/rock-fm-2/%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%/rock-fm-3/%' THEN 'BCN'

          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.magic%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.planetrock%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.coolfm%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.kerrangradio%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.forth1%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.wave105%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.mellowmagic%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.key103%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.radiocity%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.magicchilled%' THEN ' Network'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.metroradio%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.metro3radio%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.rockfm%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.heatworld%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.hallamfm%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.hallam3%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.thehitsradio%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.kissfmuk%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%kisstory.kissfmuk%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%kissfresh.kissfmuk%' THEN 'National'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.northsound1%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.downtown%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.tayfm%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.mfr%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.westfm%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.vikingfm%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.cfmradio%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.tfmradio%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.downtowncountry%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.radioborders%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.westsound%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.tay2%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.hallam2%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.radioaire2%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.northsound2%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.key2radio%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.viking2%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.metro2radio%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.tfm2%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.forth3%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.tay3%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.key3radio%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.viking3%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.radioaire3%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.tfm3%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.clyde1%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.clyde2%' THEN 'BCN'
          WHEN ${TABLE}.hits.page.pagePath LIKE '%radioplayer.clyde3%' THEN 'BCN'
          ELSE 'Planet Radio'
        END
         ;;
  }
