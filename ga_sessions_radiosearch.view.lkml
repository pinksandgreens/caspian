view: ga_sessions_radiosearch {
  ...
  derived_table: {
    sql: SELECT
      ...
      FROM
        ( SELECT * FROM {% table_date_range ga_sessions_radio.date_filter 127467161.ga_sessions_ %},
      {% table_date_range ga_sessions_radio.date_filter 127467161.ga_sessions_intraday_ %})
      GROUP BY 1
      ORDER BY 1
       ;;
  }
