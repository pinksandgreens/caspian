...
view: ga_sessions_winit {
    sql_table_name: ( SELECT * FROM {% table_date_range date_filter 85365556.ga_sessions_ %},
      {% table_date_range date_filter 85365556.ga_sessions_intraday_ %})
     ;;
     # - view: ga_sessions
     #   sql_table_name: |
