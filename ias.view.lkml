view: ias {
  ...
  dimension: host1 {
   ...
   WHEN ${TABLE}.host LIKE '%http://practicalfishkeeping.co.uk%' THEN 'PFK'
   ...
   WHEN ${TABLE}.host LIKE '%http://www.practicalphotography.com%' THEN 'PFK'
   ...
   WHEN ${TABLE}.host LIKE '%https://forum.practicalfishkeeping.co.uk%' THEN 'PFK'
   ...
   WHEN ${TABLE}.host LIKE '%https://www.classiccarsforsale.co.uk%' THEN 'CCFS'
   ...
   WHEN ${TABLE}.host LIKE '%https://www.practicalfishkeeping.co.uk%' THEN 'PFK'
  ...
  dimension: host2 {
   ...
   WHEN ${TABLE}.host LIKE '%http://kissfresh.kissfmuk.com%' THEN 'Kiss'
