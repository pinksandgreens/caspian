              ...
              FROM
                ...
                FROM  
                 (SELECT
                  ...
                  FROM
                   (SELECT * FROM TABLE_QUERY([uplifted-light-89310:33837059],'table_id CONTAINS "ga_sessions"')),
                   (SELECT * FROM TABLE_QUERY([uplifted-light-89310:24238224],'table_id CONTAINS "ga_sessions"')),
