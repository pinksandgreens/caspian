  ...
  derived_table: {
    ...
    FROM
      ...
      LEFT OUTER JOIN
        ...
        FROM
          (TABLE_DATE_RANGE([uplifted-light-89310:111489521.ga_sessions_], DATE_ADD(USEC_TO_TIMESTAMP(UTC_USEC_TO_MONTH(now())), -2, 'MONTH'), DATE_ADD(USEC_TO_TIMESTAMP(UTC_USEC_TO_MONTH(now())), -1, 'DAY')))
