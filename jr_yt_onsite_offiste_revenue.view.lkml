    ...
    sql: SELECT
        ...
        (SELECT
          ...
          FROM
            ...
            WHERE TIMESTAMP(date) BETWEEN DATE_ADD(TIMESTAMP(CURRENT_DATE()),-65,"DAY") AND DATE_ADD(TIMESTAMP(CURRENT_DATE()),-3,"DAY") AND (playback_location_type = 0 OR playback_location_type = 2 OR playback_location_type = 5)
          ...
          LEFT OUTER JOIN
            ...
            FROM
              Youtube.p_content_owner_playback_location_a2_Youtube
            WHERE TIMESTAMP(date) BETWEEN DATE_ADD(TIMESTAMP(CURRENT_DATE()),-65,"DAY") AND DATE_ADD(TIMESTAMP(CURRENT_DATE()),-3,"DAY") AND playback_location_type = 1
        ...
        (SELECT
          ...
          WHERE TIMESTAMP(date) BETWEEN DATE_ADD(TIMESTAMP(CURRENT_DATE()),-65,"DAY") AND DATE_ADD(TIMESTAMP(CURRENT_DATE()),-3,"DAY")
...
;;
  ...
  dimension: 30_day_buckets  {
    ...
    sql:  CASE
                WHEN DATEDIFF(DATE_ADD(CURRENT_TIMESTAMP(),-3,"DAY"),TIMESTAMP(${TABLE}.Date)) BETWEEN 3 AND 32 THEN 1 --Amended Range for Gregs Presentation
                WHEN DATEDIFF(DATE_ADD(CURRENT_TIMESTAMP(),-3,"DAY"),TIMESTAMP(${TABLE}.Date)) BETWEEN 33 AND 62 THEN 2 --Amended Range for Gregs Presentation
            END ;;
  }
