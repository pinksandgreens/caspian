    ...
    sql: SELECT
        ...
        (SELECT
          ...
          FROM
            ...
            WHERE TIMESTAMP(date) BETWEEN DATE_ADD(TIMESTAMP(CURRENT_DATE()),-63,"DAY") AND DATE_ADD(TIMESTAMP(CURRENT_DATE()),-4,"DAY") AND (playback_location_type = 0 OR playback_location_type = 2 OR playback_location_type = 5)
          ...
          LEFT OUTER JOIN
            ...
            FROM
              Youtube.p_content_owner_playback_location_a2_Youtube
            WHERE TIMESTAMP(date) BETWEEN DATE_ADD(TIMESTAMP(CURRENT_DATE()),-63,"DAY") AND DATE_ADD(TIMESTAMP(CURRENT_DATE()),-4,"DAY") AND playback_location_type = 1
        ...
        (SELECT
          ...
          WHERE TIMESTAMP(date) BETWEEN DATE_ADD(TIMESTAMP(CURRENT_DATE()),-63,"DAY") AND DATE_ADD(TIMESTAMP(CURRENT_DATE()),-4,"DAY")
...
;;
  ...
  dimension: 30_day_buckets  {
    ...
    sql:  CASE
                WHEN DATEDIFF(DATE_ADD(CURRENT_TIMESTAMP(),-4,"DAY"),TIMESTAMP(${TABLE}.Date)) BETWEEN 0 AND 29 THEN 1
                WHEN DATEDIFF(DATE_ADD(CURRENT_TIMESTAMP(),-4,"DAY"),TIMESTAMP(${TABLE}.Date)) BETWEEN 30 AND 59 THEN 2
            END ;;
  }
