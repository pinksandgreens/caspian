view: media_net {
  ...
  dimension: adunitname {
    label: "Ad Unit Name"
    type: string
    sql: REPLACE(${TABLE}.adunitname,'Winit - ','Winit ') ;;
  }
  ...
  dimension: is_winit {
    ...
    type: string
    sql: CASE
          WHEN ${TABLE}.adunitname LIKE '%Winit%' THEN 'Winit'
          ELSE 'Website'
         END;;
  }
  ...
  dimension: Brand_Name {
    ...
    sql: CASE
          ...
          WHEN LOWER(${brand}) LIKE '%fhm%' THEN 'FHM'
          ...
          WHEN LOWER(${brand}) LIKE '%motorcyclenews%' THEN 'Motorcyclenews'
          ...
          WHEN LOWER(${brand}) LIKE '%modernclassics%' THEN 'Modern Classics'
          WHEN LOWER(${brand}) LIKE '%model%' THEN 'Model Rail'
          WHEN LOWER(${brand}) LIKE '%other%' THEN 'Other'
          WHEN LOWER(${brand}) LIKE '%recipesplus%' THEN 'Recipes Plus'
          WHEN LOWER(${brand}) LIKE '%seaangler%' THEN 'Sea Angler'
          WHEN LOWER(${brand}) LIKE '%mcnsport%' THEN 'MCN Sports'
          WHEN LOWER(${brand}) LIKE '%mojo%' THEN 'Mojo'
          WHEN LOWER(${brand}) LIKE '%uk%' THEN 'UK General'
          ...
          WHEN LOWER(${brand}) LIKE '%todaysgolfer%' THEN 'Today''s Golfer'
          ...
          WHEN LOWER(${brand}) LIKE '%builtmag%' THEN 'Built'
          WHEN LOWER(${brand}) LIKE '%clickswin%' THEN 'Clicks Win'
          WHEN LOWER(${brand}) LIKE '%fleet news%' THEN 'Fleet News'
          WHEN LOWER(${brand}) LIKE '%kerrang%' THEN 'Kerrang'
          WHEN LOWER(${brand}) LIKE '%lro%' THEN 'Landrover Owner'
          WHEN LOWER(${brand}) LIKE '%match%' THEN 'Match'
          WHEN LOWER(${brand}) LIKE '%qthemusic%' THEN 'Q'
          WHEN LOWER(${brand}) LIKE '%qthemusic%' THEN 'Q'
          WHEN LOWER(${brand}) LIKE '%photoanswers%' THEN 'Photo Answers'
          WHEN LOWER(${brand}) LIKE '%winsomething%' THEN 'Win Something'
          ELSE LOWER(${brand})
        END
         ;;
  }
  ...
  dimension: marketplace {
    type: string
    sql: CASE
          WHEN ${TABLE}.channelname LIKE 'There is no OMP/PMP classifier in Adsense' THEN NULL
          ELSE 'OMP'
          END;;
  }
