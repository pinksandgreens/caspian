- view: social_twitter_likes_not_our_brands
  sql_table_name: publications.social_twitter_likes_not_our_brands
  fields:
  ...
  - measure: Twitter_Engagement
    value_format: '#.00%'  
    type: number
    sql: ${social_twitter_likes_not_our_brands.favouritesCount}/${social_twitter_likes_not_our_brands.statusesCount}
